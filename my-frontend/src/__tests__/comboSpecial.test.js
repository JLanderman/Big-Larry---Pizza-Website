...
beforeEach(() =>{
    DataService.getComboSpecial.mockResolvedValue(mockResponse);
...
describe("Combo Specialties", () => {
    ...
    test("renders correctly", async () => {
        ...
        // Test results
        const comboSp = screen.getByTestId("comboSpecials");
        expect(comboSp).toBeInTheDocument();
    ...
    test("should handle error in retrieveItems", async () =>{
        ...
        const consoleError = jest.spyOn(console, 'error').mockImplementation(() => { });
        const mockedError = new Error('Mocked Error');
        DataService.getComboSpecial.mockRejectedValue(mockedError);
