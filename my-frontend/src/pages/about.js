...
import storeFront from '../images/Other/SamsPizzaStorefront.jpg';
import '../App.css';
		...
		<div>
			<div className="aboutContainerStyle" data-testid="about">
				<div className='aboutRowOne' style={{ border: '0px solid black' }}>
					...
					<div className='aboutColumnPictures2' style={{ width: '100%', height: '100%', border: '0px solid black' }}>
						<iframe
					...
					<div className='aboutColumnAddress' style={{ border: '0px solid black' }}>
