...
const Cart = (props) => {
	...
	const retrieveItems = () => {
	  ...
	  return (
		  <div>
			<h1 className="card" style={{paddingLeft:'40%', paddingTop:'1%', paddingBottom:'1%', borderBottom:'1px solid black', background: 'transparent', borderColor: 'transparent'}}>Sam's Combo Sets</h1>
			<div className="row">
			  {!Array.isArray(items)
